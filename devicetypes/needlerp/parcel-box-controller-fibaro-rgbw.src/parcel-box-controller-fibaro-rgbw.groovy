 ...
 *
 *  SmartThings Device Handler for: Fibaro RGBW Controller EU v2.x (FGRGBWM-441) to act as a parcel box controller
 *
 *  Modified by Paul Needler from original code developed by David Lomas (codersaur)
 *
 ...
 **/
metadata {
    definition (name: "Parcel Box Controller (Fibaro RGBW)", namespace: "needlerp", author: "Paul Needler") {
        capability "Actuator"
        capability "Switch"
 ...
 */       
        ...
        standardTile("mode", "device.mode", width: 4, height: 2, decoration:"flat") {
            ...
            state "disabled", label:"", icon:"https://raw.githubusercontent.com/needlerp/SmartThings/master/icons/mainDisabled.png"
        ...
        standardTile("summary", "device.mode", width: 1, height: 1, decoration:"flat") {
            ...
            state "disabled", label:"disabled", icon:"https://raw.githubusercontent.com/needlerp/SmartThings/master/icons/summaryOff.png", backgroundColor:"#FF0000"
        ...
        standardTile("powerState", "device.powerState",inactiveLabel:false, width: 2, height:1, decoration:"flat") {
            ...
            state "disabled", label:"", action:"powerOn", icon:"https://raw.githubusercontent.com/needlerp/SmartThings/master/icons/boxEnabled.png"
        }
...
def powerOff(param) {
	if (param != false) { // button was pressed, not run via timer
    	setLockStatus()
    	sendEvent(name: "powerState", value:'disabled')
        log.trace "powerOff: Disabled"
	} else {
    	sendEvent(name: "powerState", value:'off')
        log.trace "powerOff: Off"
    }
